...
<head>
    <meta charset="utf-8">
    <title>Agentist - Digital Marketing Agency</title>
    <link rel="icon" type="image/x-icon" href="agentist-1.png">
    ...
    <div class="container-fluid bg-primary text-white d-none d-lg-flex">
        <div class="container py-3">
            <div class="d-flex align-items-center">
                <a href="index.html">
                    <h2 class="text-white fw-bold m-0">Agentist</h2>
                </a>
                <div class="ms-auto d-flex align-items-center">
                    <small class="ms-4"><i class="fa fa-map-marker-alt me-3"></i>lucknow, uttar pradesh, india</small>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="index.html" class="navbar-brand d-lg-none">
                    <h1 class="fw-bold m-0">Agentist</h1>
                </a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>lucknow, uttar pradesh, india</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 9305152223</p>
